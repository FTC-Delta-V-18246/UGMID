...
public class ringPipeline extends OpenCvPipeline {
    ...
    public double topRectWidthPercentage = 0.65;
    public double topRectHeightPercentage = 0.65;
    public double bottomRectWidthPercentage = 0.65;
    public double bottomRectHeightPercentage = 0.75;
