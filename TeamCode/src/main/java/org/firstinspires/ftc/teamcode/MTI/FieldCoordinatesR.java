...
public class FieldCoordinatesR {
    ...
    public static Pose2d WCI = new Pose2d(31, -61,Math.PI);
    public static Pose2d WCIB = new Pose2d(40, -46,5.0*Math.PI/6.0);
    public static Pose2d WCII = new Pose2d(40, -46, 5.0*Math.PI/6.0);
